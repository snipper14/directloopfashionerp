...
class DashboardReportController extends Controller
{
    function fetch()
    {
        ...
        $data = [$this->accountDrPayable(), $this->accountDrExpenses(), $this->accountPayable(), $this->accountReceivable()];
        //$data=[$this->accountPayable(), $this->accountReceivable()] ;
        $data2 = array_merge($data, $this->fetchLedger());
        //$data3 = array_merge($data2, $this->crledger());
        return response()->json($data2);
    }
    function fetchAssets()
    {
        $data = [$this->accountDrPayable(), $this->accountDrExpenses(), $this->accountReceivable()];
    ...
    {
       // $data = [$this->accountPayable(), $this->accountInvoiceSales()];
    ...
    function accountPayable()
    {
        ...
        SUM(credit-debit) AS actual_balance')->first();
        $data = array('type' => 'cr', 'account' => "Account Payable", 'dr_amount' => 0, 'cr_amount' => $res->actual_balance);
        return $data;
    }
    ...
    public function accountReceivable()
    {
        ...
        $data = array('type' => 'dr', 'account' => "Account Receivable ", 'dr_amount' => $res->total_balance, 'cr_amount' => 0);
        return $data;
    }
    public function accountInvoiceSales()
    {
        ...
        $data = array('type' => 'cr', 'account' => "Sales", 'dr_amount' => 0, 'cr_amount' => ($this->calculatePOSSales()));
        return $data;
    }
