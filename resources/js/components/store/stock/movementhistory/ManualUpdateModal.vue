<template>
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">Physical Update History</div>
...
export default {
    ...
    methods: {
        async fetchMergedHist() {
            const res = await this.getApi("data/stock_update/fetchUpdateByTimesmtamp", {
                params: {
                    stock_id: this.details_data.id,
                    created_at:this.formatDateTime(this.info_data.created_at)
                },
            });
            if (res.status === 200) {
                this.data = res.data;
