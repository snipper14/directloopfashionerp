ManualIncrementHistoryModal<template>
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">Physical Decrement History</div>
...
export default {
    ...
    methods: {
        async fetchMergedHist() {
            const res = await this.getApi("data/stock_update/fetchDecrementByTimesmtamp", {
                params: {
