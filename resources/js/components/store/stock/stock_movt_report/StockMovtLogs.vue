        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                ...
                <div class="card" v-if="isReadPermitted">
                    ...
                    >
                        <div class="col-md-5">
                            <h3><b>Stock Movement Logs</b></h3>
                        </div>
                        <div class="col-3">
                            <button
                                class="btn btn-primary btn-sm"
                                @click="$router.push('stock_movement_report')"
                            >
                                View Stock Movement
                            </button>
                        </div>
                            ...
                            >
                                ...
                                <tbody>
                                    ...
                                    >
                                        ...
                                        <td>
                                            {{ cashFormatter(data.grn_qty) }}
                                        </td>

                                        <td>
                                            {{ cashFormatter(data.issued_qty) }}
                                        </td>
...
export default {
    ...
    methods: {
        async downLoadPdf(issue_no) {
            this.showLoader();
            axios({
                url: "data/mx_stock_movt/downloadPdfLogs",
                params: {
        ...
        async fetchExcel() {
            this.showLoader();
            const res = await this.getApi("data/mx_stock_movt/fetchAll", {
                params: {
                    search: this.search.length >= 2 ? this.search : "",
