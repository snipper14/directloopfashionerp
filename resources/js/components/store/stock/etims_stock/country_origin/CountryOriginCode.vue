<template>
    <div class="container">
        <div class="row justify-content-center">
            ...
            <div class="col-md-10">
                <div class="card">
                    <div class="card-header">Product Country Origin</div>
                    ...
                    <div class="card-body">
                        ...
                        >
                            ...
                            <tbody>
                                <tr
                                    class="small-tr"
                                    v-for="(data, i) in country_data.data"
                                    :key="i"
                                >
                                    <td>{{ data.id }}</td>
                                    <td>{{ data.name }}</td>
...
export default {
    ...
    methods: {
        async deleteProductCategory(id, i) {
            ...
            if (shouldDelete) {
                const res = await this.callApi(
                    "delete",
                    "data/etims_country_origin_code/destroy/" + id,
                    ""
                );
        ...
        async saveRecord() {
            ...
            const res = await this.callApi(
                "post",
                "data/etims_country_origin_code/create",
                this.form_data
            );
            this.hideLoader();
        ...
        async updateProductCategory() {
            ...
            const res = await this.callApi(
                "put",
                "data/etims_country_origin_code/update",
                combinedObject
            );
            this.hideLoader();
        ...
        async fetch(page) {
            ...
            const res = await this.getApi("data/etims_country_origin_code/fetch", {
                params: {
                    page,
                    ...this.params,
                },
