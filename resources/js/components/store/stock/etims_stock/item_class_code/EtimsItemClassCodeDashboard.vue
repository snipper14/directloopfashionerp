...
export default {
    ...
    methods: {
        async deleteProductCategory(id, i) {
            ...
            if (shouldDelete) {
                const res = await this.callApi(
                    "delete",
                    "data/etims_item_class_code/destroy/" + id,
                    ""
                );
        ...
        async saveRecord() {
            ...
            const res = await this.callApi(
                "post",
                "data/etims_item_class_code/create",
                this.form_data
            );
            this.hideLoader();
        ...
        async updateProductCategory() {
            ...
            const res = await this.callApi(
                "put",
                "data/etims_item_class_code/update",
                combinedObject
            );
            this.hideLoader();
        ...
        async getClassification(page) {
            //   this.showLoader();
            const res = await this.getApi("data/etims_item_class_code/fetch", {
                params: {
                    page,
                    ...this.params,
                },
        ...
        async concurrentApiReq() {
            this.showLoader();
            const res = await Promise.all([this.getClassification(1)]).then(
                function (results) {
                    return results;
                }
            );
