<template>
    <div class="container">
        <div class="row justify-content-center">
            ...
            <div class="col-md-10">
                <div class="card">
                    <div class="card-header">Item Packaging Code</div>
                    ...
                    <div class="card-body">
                        ...
                        >
                            ...
                            <tbody>
                                <tr
                                    class="small-tr"
                                    v-for="(data, i) in packaging_code_data.data"
                                    :key="i"
                                >
                                    <td>{{ data.id }}</td>
                                    <td>{{ data.name }}</td>
                        ...
                        <Modal
                            ...
                            title="Update Item Packaging Code"
                        >
                            <div class="row">
                                <div
...
export default {
    ...
    methods: {
        async deleteProductCategory(id, i) {
            ...
            if (shouldDelete) {
                const res = await this.callApi(
                    "delete",
                    "data/etims_item_packaging_code/destroy/" + id,
                    ""
                );
        ...
        async saveRecord() {
            ...
            const res = await this.callApi(
                "post",
                "data/etims_item_packaging_code/create",
                this.form_data
            );
            this.hideLoader();
        ...
        async updateProductCategory() {
            ...
            const res = await this.callApi(
                "put",
                "data/etims_item_packaging_code/update",
                combinedObject
            );
            this.hideLoader();
        ...
        async fetch(page) {
            ...
            const res = await this.getApi("data/etims_item_packaging_code/fetch", {
                params: {
                    page,
                    ...this.params,
                },
            ...
            if (res.status == 200) {
                this.packaging_code_data = res.data;
            } else {
