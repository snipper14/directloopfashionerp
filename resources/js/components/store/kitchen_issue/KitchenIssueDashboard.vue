        ...
        <div class="row justify-content-center" v-if="isReadPermitted">
            <div class="col-md-8">
                <v-btn color="primary" dark @click="showModal()"
                    >Add Kitchen Items</v-btn
                >
                <div class="card">
                    <div class="card-header"><h3>KITCHEN ISSUE</h3></div>
...
import CreateKitchenItems from "./CreateKitchenItems.vue";
import Treeselect from "@riophae/vue-treeselect";
import "@riophae/vue-treeselect/dist/vue-treeselect.css";
export default {
    components: { CreateKitchenItems, Unauthorized,Treeselect },
    data() {
        return {
