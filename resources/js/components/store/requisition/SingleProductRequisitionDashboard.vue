                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            ...
                            >
                                ...
                                <div class="col-md-5">
                                    <b> <h3>Single Items Requisition</h3></b>
                                </div>
...
<script>
import SingleRequistionItemsDetails from "./SingleRequistionItemsDetails.vue";
import Pagination from "../../utilities/Pagination.vue";
import RequisitioNav from "./RequisitioNav.vue";
import NewRequisition from "./NewRequisition.vue";
import {
    mdiMicrosoftExcel,
    mdiPlusThick,
    mdiFileExcel,
    ...
    methods: {
        ...
        async deleteData(req_id, i) {
            ...
            if (shouldDelete) {
                const res = await this.callApi(
                    "delete",
                    "data/requisition/delete/" + req_id,
                    ""
                );
        ...
        async concurrentApiReq() {
            this.showLoader();
            await Promise.all([this.fetchRequistion(1)]).then(function(
                results
            ) {
                return results;
            });
        ...
        async fetchRequistion(page) {
            ...
            const res = await this.getApi("data/requisition/fetch", {
                params: {
