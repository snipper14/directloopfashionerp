<template>
    <div class="row">
        <div class="col-12">
              <v-btn
                class="ma-2 v-btn-primary mr-3"
                @click="$router.push('issue_store')"
                color="primary"
                dark
            >
                <v-icon dark left>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            >
                                ...
                                <div class="col-md-5">
                                    <h3><b>Main Store Issue Report</b></h3>
                                </div>
...
export default {
    ...
    methods: {
        async downloadIssueNote(issue_no) {
            this.showLoader();
            axios({
                url: "data/main_store_issue/downloadIssueNote/" + issue_no,
        ...
        async fetchAll() {
            ...
            const res = await this.getApi(
                "data/main_store_issue/fetchIssueData",
                {
                    params: {
        ...
        async concurrentApiReq() {
            ...
            await Promise.all([this.fetchIssueData(1)]).then(function(results) {
                return results;
            });
