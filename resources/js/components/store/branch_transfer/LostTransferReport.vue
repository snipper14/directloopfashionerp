                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table
                                class="table table-sm table-striped table-bordered stylish-table custom-table"
                                id="content"
                            >
                                <thead>
                                    <tr>
                        ...
                        <pagination
                            v-if="lost_stock_data !== null"
                            v-bind:results="lost_stock_data"
                            v-on:get-page="fetchLostTransfer"
                        ></pagination>
                        Items Count {{ lost_stock_data.total }}
                        <div class="row">
    ...
    methods: {
        ...
        async exporExcel() {
            const res = await this.getApi(
                "data/branch_stock_transfer/fetchLostTransfer",
                {
                    params: {
                        ...this.params,
                    },
        ...
        async concurrentApiReq(page) {
            ...
            await Promise.all([this.fetchLostTransfer(page)]);
