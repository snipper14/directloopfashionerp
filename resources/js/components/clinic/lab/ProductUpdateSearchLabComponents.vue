<template>
    <div class="row justify-content-center">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="row">
                            ...
                            <div class="col-md-2 form-group">
                                <Button
                                    v-if="pending_lab_data.length > 0"
                                    class="btn btn-secondary"
                                    x-small
                                    @click="printPrescription"
                                >
                                    Print Lab Consumables
                                </Button>
                            </div>
                        </div>
        ...
        <PrintLabconsumable
            v-if="show_print"
            ref="PrintLabconsumable"
            :pending_lab_data="pending_lab_data"
...
import PrintLabconsumable from "./PrintLabconsumable.vue";
export default {
    components: { PrintLabconsumable },
    props: ["edit_data", "form_data", "details_data"],
    data() {
        return {
            show_print: false,
            search_results: [],
    ...
    methods: {
        async printPrescription() {
            ...
            if (res.status == 200) {
                ...
                setTimeout(() => {
                    this.$refs.PrintLabconsumable.printBill();
        ...
        async fetchPendingProducts() {
            this.showLoader();
            const res = await this.getApi("data/lab/fetchCompletedLabresult", {
                params: {
