<template>
    <div class="container">
        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">Update Medical Data</div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="tab-content" id="nav-tabContent">
                            ...
                            >
                                <div class="row mt-3">
                                    ...
                                    <div class="col-md-12">
                                        <update-prescription-component
                                            :edit_data="details_data"
                                            :customer_id="
                        ...
                        <div class="row">
                            <v-btn
                                @click="updatePatientsInfo()"
                                :loading="btn_loading"
                                color="primary"
                                >Update Patients Information</v-btn
                            >
                        </div>
                    </div>
                </div>
...
import UpdatePrescriptionComponent from "./UpdatePrescriptionComponent.vue";
export default {
    components: { AddPrescriptionComponent, UpdatePrescriptionComponent },
    props: ["details_data"],
    data() {
        return {
            prescription_data: [],
    ...
    mounted() {
       ...
       console.log(JSON.stringify(this.formData));
        this.formData.imaging_results = null;
        this.formData.imaging_path = this.details_data.imaging_path;
    },
    methods: {
        isPDF(url) {
            url = url.toLowerCase();
        ...
        async updatePatientsInfo() {
            ...
            const res = await this.callApi("post", "data/medical/update", data);
