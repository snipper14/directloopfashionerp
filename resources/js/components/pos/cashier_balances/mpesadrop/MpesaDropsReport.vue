<template>
    <div class="container">
                            ...
                            >
                                ...
                                <tbody>
                                    ...
                                    >
                                        ...
                                        <td>
                                            {{
                                                cashFormatter(data.mpesa_amount)
                                            }}
                                        </td>
                                        <td>
                                            {{
                                                data.mpesadrawer_account.account
                                            }}
                                        </td>
        ...
        <div class="row">
            <ReprintMpesadropReceipt
                v-if="show_print"
                ref="ReprintMpesadropReceipt"
                :printData="printData"
            />
        </div>
...
import ReprintMpesadropReceipt from "./ReprintMpesadropReceipt.vue";
...
export default {
    ...
    methods: {
        async reprintCahDrop(data) {
            ...
            setTimeout(() => {
                this.$refs.ReprintMpesadropReceipt.printReceipt();
            }, 1000);
        },
        async fetchExcel() {
            ...
            res.data.map((data) => {
                data_array.push({
                    ...
                    mpesadrawer_account: data.mpesadrawer_account.account,
