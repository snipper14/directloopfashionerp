<template>
    <div class="container">
        ...
        <CardPaymentPrintBalance
            ref="CardPaymentPrintBalance"
...
import CardPaymentPrintBalance from "./CardPaymentPrintBalance.vue";
export default {
    props: ["details_data"],
    components: {
    ...
    methods: {
        async printCard() {
            ...
            setTimeout(() => {
                this.$refs.CardPaymentPrintBalance.printReceipt();
