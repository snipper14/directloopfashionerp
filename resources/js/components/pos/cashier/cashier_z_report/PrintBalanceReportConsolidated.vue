        ...
        <div style="max-width: 300px;float-left">
                ...
                <tr>
                    ...
                    <td class="top_row">
                        ...
                        <div style="width: 15%">
                            <b>
                                {{
                                    cashFormatter(reprint_data.cash_payments)
                                }}</b
                            >
                        </div>
                    </td>
                    <td class="top_row">
                        ...
                        <div style="width: 15%">
                            <b>
                                {{
                                    cashFormatter(reprint_data.mpesa_payments)
                                }}</b
                            >
                        </div>
                    </td>
                    <td class="top_row">
                        ...
                        <div style="width: 15%">
                            <b>
                                {{
                                    cashFormatter(reprint_data.card_payments)
                                }}</b
                            >
                        </div>
                    </td>
                    ...
                    <td class="top_row">
                        ...
                        <div style="width: 15%">
                            <b>
                                {{
                                    cashFormatter(reprint_data.credit_payments)
                                }}</b
                            >
                        </div>
                    </td>
                ...
                <tr>
                    ...
                    <td class="top_row">
                        ...
                        <div style="width: 15%">
                            <b>
                                {{
                                    cashFormatter(reprint_data.expected_cash)
                                }}</b
                            >
                        </div>
                    </td>
                ...
                <tr>
                    <td class="top_row">
                        ...
                        <div style="width: 15%">
                            <b>
                                {{
                                    cashFormatter(reprint_data.expected_mpesa)
                                }}</b
                            >
                        </div>
                    </td>
                ...
                <tr>
                    <td class="top_row">
                        ...
                        <div style="width: 15%">
                            <b>
                                {{
                                    cashFormatter(reprint_data.expected_card)
                                }}</b
                            >
                        </div>
                    </td>
                ...
                <tr>
                    ...
                    <td class="top_row">
                        ...
                        <div style="width: 15%">
                            <b>
                                {{
                                    cashFormatter(reprint_data.closing_cash)
                                }}</b
                            >
                        </div>
                    </td>
                ...
                <tr>
                    <td class="top_row">
                        ...
                        <div style="width: 15%">
                            <b>
                                {{
                                    cashFormatter(reprint_data.closing_mpesa)
                                }}</b
                            >
                        </div>
                    </td>
                ...
                <tr>
                    <td class="top_row">
                        ...
                        <div style="width: 15%">
                            <b>
                                {{
                                    cashFormatter(reprint_data.closing_card)
                                }}</b
                            >
                        </div>
                    </td>
                ...
                <tr>
                    ...
                    <td class="top_row">
                        ...
                        <div style="width: 15%">
                            <b>
                                {{
                                    cashFormatter(reprint_data.cash_shortover)
                                }}</b
                            >
                        </div>
                    </td>
                ...
                <tr>
                    <td class="top_row">
                        ...
                        <div style="width: 15%">
                            <b>
                                {{
                                    cashFormatter(reprint_data.mpesa_shortover)
                                }}</b
                            >
                        </div>
                    </td>
                ...
                <tr>
                    <td class="top_row">
                        ...
                        <div style="width: 15%">
                            <b>
                                {{
                                    cashFormatter(reprint_data.card_shortover)
                                }}</b
                            >
                        </div>
                    </td>
                ...
                <tr>
                    ...
                    <td class="top_row">
                        ...
                        <div style="width: 15%">
                            <b>
                                {{
                                    cashFormatter(reprint_data.tax_collected)
                                }}</b
                            >
                        </div>
                    </td>
            ...
            <table width="100%">
                ...
                <tr
                    v-for="(
                        data, i
                    ) in reprint_data.close_register_hourly_sales"
                    :key="i"
                >
                    <td class="top_row">
                        <div style="width: 15%">
