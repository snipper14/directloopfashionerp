<template>
    <div class="container">
            ...
            <div class="col-md-12">
                <div class="row justify-content-left">
                    ...
                    <div class="col-md-2">
                        <v-btn
                            color="primary"
                            @click="setActiveComponent('mpesa_pay')"
                            x-small
                            >MPesa Payments</v-btn
                        >
                    </div>
                    <div class="col-md-2">
                        <v-btn
                            color="primary"
                            @click="setActiveComponent('card_pay')"
                            x-small
                            >Card Payments</v-btn
                        >
                    </div>
        ...
        <mpesa-payments-balance-details
            :details_data="details_data"
            v-if="active.mpesa_pay"
        />
          <card-payment-balance-report
            :details_data="details_data"
            v-if="active.card_pay"
        />
    </div>
</template>

<script>
import CardPaymentBalanceReport from './CardPaymentBalanceReport.vue';
import ConsolidatedDetailsReport from "./ConsolidatedDetailsReport.vue";
import MpesaPaymentsBalanceDetails from "./MpesaPaymentsBalanceDetails.vue";
export default {
    props: ["details_data"],
    components: {
        ConsolidatedDetailsReport,
        MpesaPaymentsBalanceDetails,
        CardPaymentBalanceReport,
    },
    data() {
        return {
            active: {
        ...
        async fetchExcel() {
            ...
            res.data.map((data) => {
                data_array.push({
                    ...
                    cash_pay: data.cash_pay + data.receipt_balance,
                    mpesa_pay: data.mpesa_pay,
                    card_pay: data.card_pay,
                    credit_pay: data.credit_pay,
