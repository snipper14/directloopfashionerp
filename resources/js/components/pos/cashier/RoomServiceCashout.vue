...
import BillClearance from "../room_service/BillClearance.vue";
export default {
    components: { BillPayment, BillClearance, OrderDetailsWithoutTotal },
    props: ["order_details"],
    data() {
        return {
            cashout: false,
    ...
    mounted() {
        ...
        this.service_charge_total = this.order_details.sum_service_charge_amount;
        this.service_charge_rate = this.order_details.service_charge_rate;
    ...
    methods: {
        ...
        async fetchOrderDetails() {
            this.showLoader();
            const res = await this.getApi("data/room_order/getByOrder", {
                params: {
