        ...
        <div class="row justify-content-center">
            ...
            <div class="col-md-10">
                <div class="card" v-if="isReadPermitted">
                    ...
                    >
                        <h4><b> Clear Waiter POS Sales</b></h4>
                    </div>
            ...
            <Modal v-model="modal.details" title="Sale Details">
                <clear-waiter-bills-receipt-details
...
import ClearWaiterBillsReceiptDetails from "./ClearWaiterBillsReceiptDetails.vue";
...
Unauthorized,
        Treeselect,
        ClearWaiterBillsReceiptDetails,
    },
    ...
    methods: {
        ...
        async fetchData() {
            const res = await this.getApi(
                "data/pos_sale/fetchPendingWaiterSales",
