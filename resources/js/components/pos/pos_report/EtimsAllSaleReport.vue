<template>
    <div class="container">
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content around mt-3">
                            ...
                            <div>
                                ...
                                <v-btn @click="direct_itax_modal=true" color="primary">View Direct From Itax</v-btn>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-3">
                                ...
                                <tbody>
                                    ...
                                    >
                                        ...
                                        <td>
                                            ...
                                            >
                                            <v-btn color="secondary" x-small @click="viewDetails(data)">Open</v-btn>
                                        </td>
                                        ...
                                        <td>
                                            {{ data.etims_customer_name }}
                                        </td>
                                        <td>
                                            {{ data.etims_customer_pin }}
                                        </td>
                                        <td> <a :href="data.sale_detail_url" target="_blank">Etims Link</a>
                                           
                                        </td>
                                        <td>{{ data.etims_date }}</td>
                                        <td>{{ data.etims_time }}</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
        ...
        /></Modal>
           <Modal
            title="Itax Direct Report"
            v-model="direct_itax_modal"
            width="1200px"
            ><etims-itax-report-modal
                v-if="direct_itax_modal"
...
import EtimsItaxReportModal from './EtimsItaxReportModal.vue';
export default {
    components: {
        POSReportNav,
        Unauthorized,
        ...
        EtimsItaxReportModal,
    },
    data() {
        return {
            direct_itax_modal:false,
            sale_details: null,
    ...
    methods: {
        ...
        async fetchData(page) {
            const res = await this.getApi(
                "data/pos_sale/fetchAllEtimsReport",
        ...
        async fetchTotals() {
            const res = await this.getApi(
                "data/pos_sale/fetchAllEtimsTotalReport",
        ...
        async fetchAllRecApi() {
            this.showLoader();
            const res = await this.getApi("data/pos_sale/fetchAllEtimsReport", {
                params: {
                    ...this.search_params,
                    search: this.search,
                    from: this.formatDateTime(this.from),
            ...
            if (res.status == 200) {
                ...
                res.data.map((array_item) => {
                    data_array.push({
                        ...
                        receipt_total: array_item.receipt_total,
                        etims_date: array_item.etims_date,
                        etims_time: array_item.etims_time,
                        endP_id: array_item.digitax_id,
                        serial_number: array_item.serial_number,
                        sale_detail_url: array_item.sale_detail_url,
                        etims_customer_name: array_item.etims_customer_name,
                        etims_customer_pin: array_item.etims_customer_pin,
                        taxable_amount_a: array_item.taxable_amount_a,
                        taxable_amount_b: array_item.taxable_amount_b,
                        taxable_amount_c: array_item.taxable_amount_c,
                        taxable_amount_d: array_item.taxable_amount_d,
                        taxable_amount_e: array_item.taxable_amount_e,
                        tax_rate_a: array_item.tax_rate_a,
                        tax_rate_b: array_item.tax_rate_b,
                        tax_rate_c: array_item.tax_rate_c,
                        tax_rate_d: array_item.tax_rate_d,
                        tax_rate_e: array_item.tax_rate_e,
                        tax_amount_a: array_item.tax_amount_a,
                        tax_amount_b: array_item.tax_amount_b,
                        tax_amount_c: array_item.tax_amount_c,
                        tax_amount_d: array_item.tax_amount_d,
                        tax_amount_e: array_item.tax_amount_e,
