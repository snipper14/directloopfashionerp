<template>
    <div id="printReceipt" ref="contentToPrint">
        <div style="max-width: 290px;float-left">
            <receipt-header-2 />
            ...
            <table style="padding-top: 2rem">
                ...
                <tr>
                    <td v-if="form_data.customer_pin">
                        Cust_PIN : {{ form_data.customer_pin }}
                    </td>
                </tr>
            </table>
            <table>
            ...
            <table>
                ...
                <tr>
                    <td>{{ this.$store.state.branch.till_no }}</td>
                </tr>
                <tr>
            ...
            <etims-footer
                v-if="etims_data && etims_qrcode_data"
...
export default {
    ...
    computed: {
  showDiscountColumn() {
    const items = Array.isArray(this.order_data) ? this.order_data : [];
    return items.some(it => Number(it?.discount || 0) > 0);
  }
},
    methods: {
