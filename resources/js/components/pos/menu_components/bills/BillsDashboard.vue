...
import AllBills from "./AllBills.vue";
...
export default {
    ...
    components: { Unauthorized, AllBills },
    ...
    methods: {
        ...
        viewBills(value) {
            this.$store.commit("setDineDepartment", value);

            this.$router.push("diner_bills");
        },
