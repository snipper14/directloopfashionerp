...
import VoidListComponent from "../dinerscomponents/VoidListComponent.vue";
import VoidListMultiComponent from "../dinerscomponents/VoidListMultiComponent.vue";
...
export default {
    ...
    ,
        ...
        async voidAll() {
            this.showLoader();
            const res = await this.callApi("POST", "data/void_sale/voidSale", {
