        ...
        <div v-if="isReadPermitted">
            <div class="jumbotron">
                <div class="row d-flex flex-column">
                    <div>
                        <h3 class="mt-4"><b>ROOM SERVICE RECEIVE CASH</b></h3>
                        <br />
                    </div>
...
import WaiterCashRoomBills from "./WaiterCashRoomBills.vue";
...
export default {
    ...
    methods: {
        ...
        async getBills() {
            const res = await this.getApi("data/room_order/fetchAllBills", {
                params: {
                    search: this.search,
                },
            });
