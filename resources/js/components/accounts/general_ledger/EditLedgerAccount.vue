...
export default {
    ...
    mounted() {
        ...
        this.form_data.account = this.edit_data.original_account;
    ...
    methods: {
        onSubAccountSelected(selectedId) {
            ...
            const list = this.main_subaccounts_select_data || [];

            const selected = list.find((opt) => opt.value === selectedId);
