            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-md-6">
                                <h3><b>Customer Ageing Report</b></h3>
                            </div>
                            <div class="col-md-3">
...
export default {
    ...
    methods: {
        ...
        async getAgingReport(page) {
            const res = await this.getApi("data/cust_ledger/getAgingReport", {
                params: {
                    page,
        ...
        async exportExcel() {
            const res = await this.getApi(
                "data/cust_ledger/exportAgingReport",
                {
                    params: {
                        ...this.params,
                    },
