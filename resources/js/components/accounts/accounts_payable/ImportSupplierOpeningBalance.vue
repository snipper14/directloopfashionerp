        ...
        <div class="col-md-8">
            <div class="form-group">
                <label class="form-control-label" for="input-file-import"
                    >Upload Supplier Opening Balance CSV Download and fill the template</label
                >
                <input
                    type="file"
                    style="width: 50%"
    ...
    methods: {
        ...
        async downLoadSample() {
            ...
            res.data.results.map((array_item) => {
                data_array.push({
                    supplier_name: array_item.company_name,
                    id: array_item.id,
                    debit_amount: 0,
                    credit_amount: 0,
                });
        ...
        proceedAction() {
            ...
            axios
                .post("data/supplier_invoice/importOpeningBalance", formData, {
