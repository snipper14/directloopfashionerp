        ...
        <div class="row justify-content-center" v-if="active.dashboard">
            ...
            <div class="col-md-10">
                <div class="card" v-if="isReadPermitted">
                    ...
                    >
                        <div class="col-md-5">
                            <h5>Revoked Assets Allocations</h5>
                        </div>
                                ...
                                >
                                    ...
                                    <td>
                                        ...
                                        title="update"
                                            ...
                                            @click="rellocateAsset(data.id,i)"
                                        >
                                           Re-Allocate
                                        </button>
                                          <button
...
export default {
    ...
    methods: {
       async deleteAsset(id, i) {
          ...
          async rellocateAsset(id, i) {
            const shouldDelete = await this.deleteDialogue();
            if (shouldDelete) {
                const res = await this.callApi(
                    "delete",
                    "data/asset_allocation/reAllocate/" + id,
                    ""
                );
