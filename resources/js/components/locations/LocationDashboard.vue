        ...
        <div class="row justify-content-center">
            ...
            <div class="col-md-10">
                <div class="card" v-if="isReadPermitted">
                    <div class="card-header"><h4><b> Location Manager</b></h4></div>
...
export default {
    ...
    methods: {
        ...
        async getData() {
            this.showLoader();
            const res = await this.getApi("data/location/fetch",  { params:{
                 search:this.search
              }});
            this.hideLoader();
            if (res.status == 200) {
