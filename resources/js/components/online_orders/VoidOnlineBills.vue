        ...
        <div v-if="isReadPermitted">
            <div class="jumbotron">
                <div class="row d-flex flex-column">
                    <div>
                        <h4 class="mt-4"><b>VOID CUSTOMER BILL</b></h4>
                        <br />
                    </div>
...
import VoidListComponent from '../pos/menu_components/dinerscomponents/VoidListComponent.vue';
import CustomBoard from '../pos/menu_components/dinerscomponents/CustomBoard.vue';
import VoidListMultiComponent from '../pos/menu_components/dinerscomponents/VoidListMultiComponent.vue';
...
export default {
    ...
    ,
        showKeyboard(e) {
            this.qty_input = e.target;
            this.qty_layout = e.target.dataset.layout;
        ...
        async submitSingle() {
            ...
            this.form_data.cost_total =
                this.form_data.qty * this.form_data.cost_price;
           
            this.showLoader();
            const res = await this.callApi(
                "POST",
                "data/void_sale/voidOnline",
                this.form_data
            );
            this.hideLoader();
            if (res.status == 200) {
        ...
        async voidAll() {
            this.showLoader();
            const res = await this.callApi("POST", "data/void_sale/voidOnlineSale", {
