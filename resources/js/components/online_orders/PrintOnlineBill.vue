        ...
        <table width="100%" class="head">
            <tr>
                <td class="printer-header" style="font-size: 2.4rem">
                    <center>
                        <h3>
                            <b>CUSTOMER INVOICE ONLINE ORDER</b
...
import BarCodeComponent from '../pos/menu_components/dinerscomponents/BarCodeComponent.vue';
...
export default {
    ...
    methods: {
        printOnlineBill: function () {
            printJS("printOnlineBill", "html");
            // this.value = value;
        },
    },
};
