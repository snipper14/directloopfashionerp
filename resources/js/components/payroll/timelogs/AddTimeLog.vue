...
export default {
    ...
    mounted() {
        this.form_data.logged_on=this.getCurrentDate()
    },
   watch:{
       employee_id:{
           handler(val){
          ...
          form_data: {
            handler(val) {
              ...
              const no_hours=parseFloat(val.no_hours)
              this.form_data.total_amount=no_hours*hrly_rate*1.5
