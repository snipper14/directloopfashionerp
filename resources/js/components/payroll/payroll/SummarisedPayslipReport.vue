                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                                    ...
                                    >
                                        ...
                                        <td>
                                             <router-link
                                                to="#"
                                                @click.native="
                                                    activateDetails(data)
                                                "
                                            >
                                          
                                                {{
                                                    formatDate(data.payroll_to)
                                                }}
                                             </router-link>
                                        </td>
                                        ...
                                        <th>{{cashFormatter(data.housing_levy)}}</th>
                            ...
                            <Pagination
                                ...
                                v-on:get-page="fetchSummarisedPayslips"
                            ></Pagination>
...
export default {
    ...
    mounted() {
        this.fetchSummarisedPayslips(1);
    },
    ...
    methods: {
        ...
        activateDetails(data){
            ...
            this.summary_details_data=data
        ...
        async fetchAll() {
            const res = await this.getApi("data/payslips/fetchAllSummarised", "");
        ...
        async fetchSummarisedPayslips(page) {
            this.showLoader();
            const res = await this.getApi("data/payslips/fetchSummarised", {
                params: {
                    page,
