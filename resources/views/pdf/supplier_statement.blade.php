    ...
    <table class="table-address">
        <tr>
            ...
            <td class="right-cont">
                <span>
                    <h4>Vendor</h4>
                    <p>{{ $data[0]['supplier']->company_name }}</p>

                    @if ($data[0]['supplier']->company_phone)
                        <p><b>Phone: </b>{{ $data[0]['supplier']->company_phone }} </p>
                    @endif
                    @if ($data[0]['supplier']->company_email)
                        <p><b>Email: </b>{{ $data[0]['supplier']->company_email }} </p>
                    @endif
                    @if ($data[0]['supplier']->country)
                        <p><b>Country: </b>{{ $data[0]['supplier']->country }}/{{ $data[0]['supplier']->city }} </p>
                    @endif
