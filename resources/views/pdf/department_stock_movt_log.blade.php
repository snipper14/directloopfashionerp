...
<body>
    ...
    <div class="row">
        <div class="col-xs-12 invoice doc-type">
            <h3>DEPARTMENT STOCK MOVEMENT LOGS REPORT</h3>
        </div>
    </div>
    <hr>
<div class="row">
    ...
    <table class="table ">
        <thead class="bg-dark">
            <tr  class="table-title">
                ...
                <td><b>system qty</b></td>
                <th><b>Physical qty</b></th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <p class="item">{{ number_format($item->stock->selling_price,2)}}</p>
                </td>
                <td> 
                    <p class="item">{{ $item->opening_dept_stock}}</p>
                </td>
                <td>
                    <p class="item">{{$item->dept_issued_qty}}</p>
                </td>
              
                
                <td>
                    <p class="item">{{ $item->dept_system_qty}}</p>
                </td>
                   <td class="item">
                    {{ $item->physical_dept_qty}} </td> 
                <td>
