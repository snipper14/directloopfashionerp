...
<body>
    ...
    <td>
        ...
        <div class="right-cont">
            ...
            @if ($data[0]->internal_issue_no)
            <p> <b>Internal Issue No: </b>{{ $data[0]->internal_issue_no }}</p>
            @endif
            <p> <b>Issue Date: </b>{{ $data[0]->date_issued }}</p>
            <p> <b>Department: </b>{{ $data[0]->department->department }}</p>
        </div>
    </td>
    </tr>
    </table>
    ...
    <table>
        ...
        <tr style="background:#eceff1; " class="title_2">
            ...
            <td>
                <p> <b class="title_2">{{ $data[0]->issued_staff->name }}</p>
            </td>
        ...
        <tbody>
            ...
            @foreach ($data as $item)
                <tr class="td-height">
                    ...
                    <td>
                        <p>{{ number_format($item->final_qty, 2) }}</p>
                    </td>
                    <td>
