...
class CreatePurchaseOrderReceivableWithBatchesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('purchase_order_receivable_with_batches', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('purchase_order_receivable_with_batches');
    }
}
